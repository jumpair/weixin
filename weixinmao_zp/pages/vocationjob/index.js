...
Page({
  ...
  onLoad: function (e) {
    ...
    var that = this;
        ...
        app.util.request({
          'url': 'entry/wxapp/myvocationjoblist',
    ...
    wx.navigateTo({
      url: "/weixinmao_zp/pages/editvocationjob/index?id=" + id
    })
  }, addvocationjob:function(e){

    wx.navigateTo({
      url: "/weixinmao_zp/pages/addvocationjob/index"
    })
  },
      ...
      doServices: function () {
        ...
        wx.showModal({
          ...
          success: function (res) {
            if (res.confirm) {
              app.util.request({
                'url': 'entry/wxapp/cancleVocationJob',
