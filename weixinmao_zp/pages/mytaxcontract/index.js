    ...
    app.util.request({
      ...
      success: function (res) {
        if (!res.data.message.errno) {
          ...
          var Taxcontract = res.data.data.Taxcontract;
          var image = res.data.data.image;

          if(Taxcontract.imagefile)
          {
          ...
          that.setData({
            ...
            city:city,
            Taxcontract: res.data.data.Taxcontract,
            imgurl1:image,
  ...
  savepubinfo: function (e) {
    ...
    var that = this;
        ...
        var data = {
          ...
          company: company,
          content: content,
          imagefile:uploadimagelist[0]
        };
        app.util.request({
          'url': 'entry/wxapp/Savetaxcontract',
          data: data,
          success: function (res) {
