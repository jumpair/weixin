...
Page({
    ...
    toMyrepair: function(e) {
        ...
        wx.navigateTo({
            url: "/weixinmao_zp/pages/companyrepair/index"
        })

    },
    toMysatffoff: function(e) {

        wx.navigateTo({
            url: "/weixinmao_zp/pages/companysatffoff/index"
        })

    },
    toAbsence: function(e) {

        wx.navigateTo({
            url: "/weixinmao_zp/pages/companyabsence/index"
        })
