...
Page({
  ...
  ,
  bindcontractdateChange: function (e) {
    var contractdate = this.data.contractdate;

    if (contractdate) {
      this.data.contractdateindex = e.detail.value;
      this.data.contractdateid = contractdate[e.detail.value].id;
    }
    this.setData({
      contractdate: contractdate,
      contractdateindex: e.detail.value
    })
  }
  ,
  ...
  savepubinfo: function (e) {
    ...
    var that = this;
      ...
      var contractdate = e.detail.value.contractdate;
    ...
    app.util.request({
      'url': 'entry/wxapp/Savetaxdeclare',
      data: data,
      success: function (res) {
