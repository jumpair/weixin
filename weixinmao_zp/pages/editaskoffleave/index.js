...
Page({
  ...
  onLoad: function (options) {
    ...
    console.log(id)
    app.util.request({
      'url': 'entry/wxapp/Editaskoffinit',
      ...
      success: function (res) {
        if (!res.data.message.errno) {
          ...
          that.setData({
            title:title,
            startofftime:res.data.data.list.startofftime,
            endofftime:res.data.data.list.endofftime,
            reason:res.data.data.list.reason
          })
...
　　}
    ...
    app.util.request({
      'url': 'entry/wxapp/Editaskoffleave',
      data: data,
      success: function (res) {
