        ...
        success: function (res) {
          if (!res.data.message.errno) {
            ...
            that.setData({
              ...
              moneyrecordlist:res.data.data.moneyrecordlist
            })
          }
        },
        complete: function () {
        ...
        wx.showModal({
          ...
          success: function (res) {
            if (res.confirm) {
              app.util.request({
                'url': 'entry/wxapp/pay',
                data: { ordertype: ordertype,companyid:companyid, pid: pid, sessionid: userinfo.sessionid, uid: userinfo.memberInfo.uid },
                success: function (res) {
                  console.log(res);
