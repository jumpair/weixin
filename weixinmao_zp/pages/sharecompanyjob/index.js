...
Page({
  ...
  console.log(userinfo);
    app.util.request({
      'url': 'entry/wxapp/getQrcodecompanyjob',
...
// this.onLoad();
  ...
  doShow: function () {
    ...
    /*
    wx.downloadFile({
     // url: 'https://www.zhenglianqi.com.cn/addons/weixinmao_jz/icon.jpg',
      url:userinfo.avatarUrl,
      success: function (res) {
          
        if (res.statusCode === 200) {
          console.log('fffftxxxxxx');
          ...
          ctx.drawImage(that.data.picfile, 20, 20, 130, 130);
          ctx.draw();
