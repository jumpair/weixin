      ...
      app.util.request({
          ...
          success: function (res) {
            if (!res.data.message.errno) {
              ...
              that.setData({
                agentinfo: res.data.data.agentinfo,
                agent_setting:res.data.data.agent_setting,
                ordertype: ordertype,
...
toMytask: function() {
    ...
    wx.navigateTo({
      url: "/weixinmao_zp/pages/mytask/index"
    })
  ...
  toMyteam:function(){
    ...
    wx.navigateTo({
      url: "/weixinmao_zp/pages/myteam/index"
    })
  },
  toFxrecord:function(){

    wx.navigateTo({
      url: "/weixinmao_zp/pages/fxrecord/index"
    })
  },

  toMymoneyjob:function(){
  

    wx.navigateTo({
      url: "/weixinmao_zp/pages/mymoneyjob/index"
    })
