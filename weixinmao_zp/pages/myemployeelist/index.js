...
Page({
  ...
  onLoad: function (e) {
    ...
    var that = this;
        ...
        app.util.request({
          'url': 'entry/wxapp/myemployeelist',
  ...
  toMyemployeemoneylist: function (e) {

    var id = e.currentTarget.dataset.id;

    wx.navigateTo({
      url: "/weixinmao_zp/pages/myemployeemoneylist/index?id=" + id
    })
  }, 
  ...
  toAddemployeemoney:  function(e) {

    var id = e.currentTarget.dataset.id;

    wx.navigateTo({
      url: "/weixinmao_zp/pages/addemployeemoney/index?id=" + id
    })
  },
