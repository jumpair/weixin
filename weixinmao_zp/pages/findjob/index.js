...
Page({
  ...
  var city = wx.getStorageSync('city');
      ...
      success: function (res) {
        if (!res.data.message.errno) {
          ...
          if (res.data.data.intro.ischeck == 1){
            ...
            wx.setNavigationBarTitle({
              title: title['findjob'] +'-'+ wx.getStorageSync('companyinfo').name,
            })
          ...
          that.setData({
            ...
            selecttitle: res.data.data.selecttitle
          })
    ...
    app.util.request({
      ...
      data: { cityid: cityid, page: that.data.page, houseareaid: that.data.houseareaid, housepriceid: that.data.housepriceid, housetype: that.data.housetype, latitude: latitude, longitude: longitude },
      success: function (res) {
        if (!res.data.message.errno) {
          that.setData({
            joblist: res.data.data.joblist,
            topjoblist:res.data.data.topjoblist,
