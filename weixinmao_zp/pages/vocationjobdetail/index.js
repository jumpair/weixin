...
Page({
  ...
  , getjobdetail:function(){
    ...
    var id = that.data.id;
    app.util.request({
      'url': 'entry/wxapp/getvocationjobdetail',
      data: data,
  ...
  , doSendjob:function(e){
    ...
    console.log(form_id);
        ...
        app.util.request({
          ...
          data: { form_id: form_id,companyid:companyid,jobid:jobid,sessionid: userinfo.sessionid, uid: userinfo.memberInfo.uid,type:2},
          success: function (res) {
  ...
  onShareAppMessage() {
    return {
      ...
      path: '/weixinmao_zp/pages/partjobdetail/index?id=' + this.data.id
    }
